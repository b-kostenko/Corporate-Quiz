...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "company_status", sa.Enum("HIDDEN", "VISIBLE", name="companystatus", native_enum=False), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACCEPTED", "DECLINED", "CANCELED", name="invitationstatus", native_enum=False),
            nullable=False,
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
