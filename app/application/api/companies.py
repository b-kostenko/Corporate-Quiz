...
async def update_company(company_id: UUID, company_input: CompanyUpdateSchema, company_service: company_service_deps, user: current_user_deps) -> CompanyOutputSchema:
...
async def change_company_status(company_id: UUID, company_status: CompanyStatus, company_service: company_service_deps, user: current_user_deps) -> CompanyOutputSchema:
