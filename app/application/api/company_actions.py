...
async def get_company_invitations(company_id: UUID, company_service: company_service_deps, user: current_user_deps):
...
async def leave_company(company_id: UUID, company_service: company_service_deps, user: current_user_deps):
    """Leave a company."""
